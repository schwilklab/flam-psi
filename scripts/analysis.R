...
lfmc_wp_species_ignition <- lm(log10(ignition_delay + 1) ~ lfmc*wp*spcode, 
...
lfmc_species_ignition <- lm(log10(ignition_delay + 1) ~ lfmc*spcode, 
                           data = filter(final_data, year == 2024 & spcode != "JUPIF"))
...
lfmc_wp_species_heat_release <- lm(heat_release_j ~ lfmc*wp*spcode,
...
lfmc_species_heat_release <- lm(heat_release_j ~ lfmc*spcode,
                               data = filter(short_ignition, year == 2024 & spcode != "JUPIF"))
...
AIC(lfmc_wp_species_heat_release, cmc_wp_species_heat_release, wp_species_heat_release, cmc_species_heat_release,
    lfmc_species_heat_release, species_heat_release) # cmc
